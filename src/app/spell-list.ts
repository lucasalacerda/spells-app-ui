...
export const SPELLS: Spell[] = [
  { id: '1', title: 'spell 1', description: 'this is an awesome spell 1', level: 1, class: { className: 'bard' } as ClassChar, img: '' },
  { id: '2', title: 'spell 2', description: 'this is an awesome spell 2', level: 2, class: { className: 'bard' } as ClassChar, img: '' },
